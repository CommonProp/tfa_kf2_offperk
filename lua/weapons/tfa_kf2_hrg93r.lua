if CLIENT then
    killicon.Add( "tfa_kf2_hrg93r", "vgui/hud/tfa_kf2_hrg93r", Color( 225, 46, 46, 255 ) )
end 
...
SWEP.Description        = "An alternative to 9mm. Also cheap, but fires more bullets. This one is for all the rapid-fire wooers."
SWEP.Type				= "Pistol"
SWEP.Purpose			= "Fire mode is burst only." --Purpose Tooltip
SWEP.PrintName			= "HRG 93R Pistol"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_kf2/hrg93r/c_kf2_hrg93r.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_kf2/hrg93r/w_kf2_hrg93r.mdl" --Wmodel path
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD_EMPTY] = {
		...
		{time = 0.3, type = "lua", value = function(wep,vm) wep:KF2DropMag(0) end, client = true, server = true }, -- 0 for right hand, 1 for left hand
