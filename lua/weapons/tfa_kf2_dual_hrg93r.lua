if CLIENT then
    killicon.Add( "tfa_kf2_dual_hrg93r", "vgui/hud/tfa_kf2_dual_hrg93r", Color( 225, 46, 46, 255 ) )
end 

SWEP.Base				= "tfa_kf2_akimbo_burst_base"
...
SWEP.Description        = "If you liked the 93R, you'll be pleased to see two of them."
SWEP.Type				= "Pistol"
SWEP.Purpose			= "Fire mode is burst only." --Purpose Tooltip
SWEP.PrintName			= "Dual HRG 93R Pistols"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage = (engine.ActiveGamemode() == "zombiesurvival" and 39) or 12 -- Damage, in standard damage points.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_kf2/hrg93r/c_kf2_dual_hrg93r.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_kf2/hrg93r/w_kf2_dual_hrg93r.mdl" --Wmodel path
...
SWEP.MagModel = Model("models/weapons/tfa_kf2/hrg93r/hrg93r_mag.mdl")
SWEP.ShellModel = "models/weapons/tfa_kf2/shared/hrg93r_shell.mdl"
